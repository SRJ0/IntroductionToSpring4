...
public class Main {
    public static void main(String[] args) {
        ...
        GenericXmlApplicationContext ctx = new GenericXmlApplicationContext("classpath:applicationContext.xml"); //설정 정보를 담고 있는 applicationContext.xml 경로를 파라미터로 생성자에 전달한다.
        //유사한 클래스로 AnnotationConfigApplicationContext 와 GenericGroovyApplicationContext가 있다

        Greeter g = ctx.getBean("greeter", Greeter.class); //context가 생성한 빈 객체를 id와 타입으로 검색한다
        ...
        System.out.println(g == g3); //는 false
